...
logger = logging.getLogger('pages_svm.py')
...
if __name__ == "__main__":
    ...
    methods.add_argument('--kernel', help='optimize a SVM classifier on the Classes database.')
    methods.add_argument('--tuned-parameters',action='store_true', help='optimize a SVM classifier on the Classes database.')
    ...
    logger.info('Use the svm model to classify the classes data')
